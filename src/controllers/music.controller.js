...
async function getAllAlbums(req, res) {
    const albums = await albumModel.findOne().populate("artist", "username email").populate("musics")

    res.status(200).json({ message : "Album fetched succesfully", albums: albums})
